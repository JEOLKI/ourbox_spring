...
<body>
   ...
   <nav>
    ...
    <aside id="left">
		...
		<div id="memProfile">
			<iframe src ="<%=request.getContextPath()%>/member/profile?mem_id=${vo.mem_id}" name="profile" id="profile"></iframe>
		</div>	
        ...
        <div id="leftMenu">
        	...
        	<iframe id="mygroup" src="<%=request.getContextPath()%>/RoomListController?memId=${vo.mem_id}" target="group" name="mygroup" frameborder="0" scrolling="no" onload="resizeIframe(this)"></iframe><br>
